...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Developer Tools}{: Git, Xcode, Android Studio, Google Cloud Platform, PyCharm, RubyMine, VSCode, Jupyter Notebook, Arduino, Figma} \\
     \textbf{Other Skills}{: Software Design, Software Architecture, UML, Software Testing, CI/CD, Parallel Computing, Thread management} \\
     \textbf{Libraries}{: Pandas, NumPy, Matplotlib, Pytorch, Multiprocessing, Scipy}
    }}
 \end{itemize}
...
\section{Other Projects}
    \resumeSubHeadingListStart
        ...
        {\textbf{{\href{https://github.com/Usgupta/LectureGenie}{\faExternalLink* LectureGenie}}} $|$ {Python, Open AI, Da-vinci, Git }}{Apr 2023 -- Apr 2023}
          ...
          \resumeProjectHeading
            {\textbf{{\href{https://github.com/Usgupta/pa_2}{\faExternalLink* RDTonUDP}}} $|$ {Python, Cryptography, Git}}{Sept 2022 -- Oct 2022}
          \resumeItemListStart
...
\resumeSubHeadingListStart
        ...
        \resumeProjectHeading
        {\textbf{{\href{https://www.linkedin.com/in/hpcclusters/}{\faExternalLink* Steve Jones}}} $|$ {Director, High Performance Computing Center @ Stanford}}{HPC Course Professor}
