...
\section{Education}
  \resumeSubHeadingListStart
    ...
    \\{Available full time from May 2023 - Sept 2023}
...
\section{Work Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Grab}{Singapore}
      \resumeItemListStart
        \resumeItem{Maintain and build new features in Grab Driver Mobile App}
        \resumeItem{Creating custom TCP socket message logger to improve debugging process}
        \resumeItem{Joined as the only Mobile Software Engineer Intern in Grab}
